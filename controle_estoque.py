...
class Janelalogin:
    ...
    def verificar_login(self):
        ...
        if usuario == "admin" and senha == "gus123":
...
class EstoqueApp:
    ...
    def novo_produto(self):
        ...
        janela_add.title("Adiocionar Produto")
    ...
    def movimentar_estoque(self, tipo):
        ...
        try:
            ...
            self.conn.commit()
            self.atualizar_tabela()
            messagebox.showinfo("Sucesso", f"Movimentação de {qtd} unidades realizados!")
        except:
    ...
    def sair(self): self,self.janela_main.quit()
